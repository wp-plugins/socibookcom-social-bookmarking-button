...
1. Upload the folder `/socibookcom-social-bookmarking-button/` to your WP plugin folder `/wp-content/plugins/` directory
2. The path must look like this: `/wp-content/plugins/socibookcom-social-bookmarking-button/`
3. Activate the plugin through the 'Plugins' menu in WordPress admin
4. You are ready, check the social bookmark buttons after your posts

== Screenshots ==

1. SociBook Social Bookmarking button
2. SociBook Social Bookmarking button
3. SociBook Social Bookmarking button
